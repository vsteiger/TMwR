...
The full set of strategies and tactics for writing R code in the tidyverse style can be found at the website <a href="https://design.tidyverse.org" target="_blank">https://design.tidyverse.org</a>. Here we can briefly describe several of the design principles, their motivation, and how we think about modeling as an application of these principles. 
